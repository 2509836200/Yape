...
{
    NSString *numberRegex=@"[0-9A-Za-z]{6,18}$";
    NSPredicate *numberTest = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", numberRegex];
...
+(void)tipMessageTitle:(NSString *)title view:(UIView *)view{
    ...
    CGSize descriptionsSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(bgView.frame.size.width-40, MAXFLOAT)];
