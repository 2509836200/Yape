...
//EaseChatBarMoreView修改更多按钮（例如：定位、发图片、拍照、语音电话、shipin）
//EMErrorCode.h SDK定义的错误类型
...
- (void)viewDidLoad {
    ...
    [self createLeftItemWithImage:@"common_back" highlightedImageName:nil target:self action:@selector(backAction)];
                    ...
                    messageType:(EMMessageBodyType)messageType
{
    ...
    if (_transpondMenuItem == nil) {
        _transpondMenuItem = [[UIMenuItem alloc] initWithTitle:NSLocalizedString(@"转发", @"转发") action:@selector(transpondMenuAction:)];
    }
